...
import {getUpcomingMovies, IGetMoviesResult, getTrailerMovies, IGetTrailerResult} from "../api";
...
function Popular() {
  ...
  const trailerMatch = useRouteMatch<{ movieId: string }>("/coming-soon/movies/:movieId");
